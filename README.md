...
- [❓ Why ParlaChore?](docs/README.md#-why-parlachore)
...
- [⚙️ Tech Stack & Control Flow](docs/README.md#️-tech-stack--control-flow)
  - [Tech Stack Overview](docs/README.md#tech-stack-overview)
  - [Request → Response → Swapper → Animation Lifecycle](docs/README.md#-request--response--swapper--animation-lifecycle)
...
- [🧪 Testing & DevOps](docs/README.md#-testing--devops)
- [🎨 Theme Families (Condensed)](docs/README.md#-theme-families-condensed)
- [🏆 Skills Demonstrated](docs/README.md#-skills-demonstrated)
...
- [👋 About Me](docs/README.md#-about-me)
  - [What I Bring](docs/README.md#what-i-bring)
  - [Connect With Me](docs/README.md#connect-with-me)
- [📌 Portfolio Note](docs/README.md#-portfolio-note)

---

## ARCHITECTURE.md
- [🧱 ParlaChore Architecture](/docs/ARCHITECTURE.md#-parlachore-architecture)
- [📂 Project Structure](/docs/ARCHITECTURE.md#-project-structure)
- [🌐 Controller Mappings](/docs/ARCHITECTURE.md#-controller-mappings)
...
- [🔄 Control Flow](/docs/ARCHITECTURE.md#-control-flow)
- [🛠 Utilities](/docs/ARCHITECTURE.md#-utilities)
- [🎨 Resources](/docs/ARCHITECTURE.md#-resources)
- [📌 Notes](/docs/ARCHITECTURE.md#-notes)
- [👥 Author & Links](/docs/ARCHITECTURE.md#-author--links)

---

## AVATARS.md
- [🧠 Avatar Prompt Examples](/docs/AVATARS.md#-avatar-prompt-examples)
  - [🐠 Undersea Theme (Timmy & Friends)](/docs/AVATARS.md#-undersea-theme-timmy--friends)
  - [🏁 Race Track Theme (Speedy Crew)](/docs/AVATARS.md#-race-track-theme-speedy-crew)
- [👥 Author & Links](/docs/AVATARS.md#-author--links)

---

## BUSINESSPLAN.md
- [📑 ParlaChore Business Plan](/docs/BUSINESSPLAN.md#-parlachore-business-plan)
...
- [👥 Author & Links](/docs/BUSINESSPLAN.md#-author--links)

---

## CODESAMPLES.md
- [ParlaChore code samples](/docs/CODESAMPLES.md#parlachore-code-samples)
- [🚀 Basic Server Setup](/docs/CODESAMPLES.md#-basic-server-setup)
- [🔐 SSL Server Setup](/docs/CODESAMPLES.md#-ssl-server-setup)
- [📈 Monitoring & Metrics](/docs/CODESAMPLES.md#-monitoring--metrics)
- [🧩 Overlay Swapper (Frontend)](/docs/CODESAMPLES.md#-overlay-swapper-frontend)
- [🌐 Controller Endpoint (Backend)](/docs/CODESAMPLES.md#-controller-endpoint-backend)
- [🎨 Theme Loader](/docs/CODESAMPLES.md#-theme-loader)
- [🪵 Logging](/docs/CODESAMPLES.md#-logging)
...
## DEPLOYMENT.md
- [🚀 ParlaChore Deployment](/docs/DEPLOYMENT.md#-parlachore-deployment)
- [🌐 Hosting & Infrastructure](/docs/DEPLOYMENT.md#-hosting--infrastructure)
- [⚙️ Environment Configuration](/docs/DEPLOYMENT.md#️-environment-configuration)
- [🔄 Deployment Flow](/docs/DEPLOYMENT.md#-deployment-flow)
- [🧪 DevOps Practices](/docs/DEPLOYMENT.md#-devops-practices)
- [📌 Notes](/docs/DEPLOYMENT.md#-notes)
- [👥 Author & Links](/docs/DEPLOYMENT.md#-author--links)

---

## MARKETING.md
- [🎤 ParlaChore Marketing Outline](/docs/MARKETING.md#-parlachore-marketing-outline)
...
- [4. Market](/docs/MARKETING.md#4-market)
  - [✨ Differentiating Points](/docs/MARKETING.md#-differentiating-points)
...
- [🔑 Pitch Tips](/docs/MARKETING.md#-pitch-tips)
- [👥 Author & Links](/docs/MARKETING.md#-author--links)

---

## ROADMAP.md
- [🗺️ Roadmap](/docs/ROADMAP.md#️-roadmap)
  - [✅ Completed Foundations](/docs/ROADMAP.md#-completed-foundations)
  - [🚧 In Progress](/docs/ROADMAP.md#-in-progress)
  - [🌟 Would Like To](/docs/ROADMAP.md#-would-like-to)
- [👥 Author & Links](/docs/ROADMAP.md#-author--links)

---

## SECURITY.md
- [🔐 ParlaChore Security](/docs/SECURITY.md#-parlachore-security)
- [🛡️ Current Security Practices](/docs/SECURITY.md#-current-security-practices)
...
- [🔒 Planned Enhancements](/docs/SECURITY.md#-planned-enhancements)
...
- [📌 Notes](/docs/SECURITY.md#-notes)
- [👥 Author & Links](/docs/SECURITY.md#-author--links)

---

## STATICASSETS.md
- [🖼️ ParlaChore Static Assets](/docs/STATICASSETS.md#-parlachore-static-assets)
    - [🎨 Theme Backgrounds](/docs/STATICASSETS.md#-theme-backgrounds)
    - [🐠 ParlaPal Avatars](/docs/STATICASSETS.md#-parlapal-avatars)
    - [🧩 UI Icons & Decorative Elements](/docs/STATICASSETS.md#-ui-icons--decorative-elements)
- [🧼 ParlaChore CSS Load Order](/docs/STATICASSETS.md#-parlachore-css-load-order)
    - [✅ Load Order](/docs/STATICASSETS.md#-load-order)
- [📦 CSS File Purposes](/docs/STATICASSETS.md#-css-file-purposes)
- [👥 Author & Links](/docs/STATICASSETS.md#-author--links)

---

## THEMES.md
- [🎨 ParlaChore Themes](/docs/THEMES.md#-parlachore-themes)
- [🌊 Undersea](/docs/THEMES.md#-undersea)
- [✈️ Airport](/docs/THEMES.md#️-airport)
- [🌌 Outer Space](/docs/THEMES.md#-outer-space)
- [🏗 Build Site](/docs/THEMES.md#-build-site)
- [🏇 Race Track](/docs/THEMES.md#-race-track)
- [🐉 Dragon Cliffs](/docs/THEMES.md#-dragon-cliffs)
- [🧚 Fairy Forest](/docs/THEMES.md#-fairy-forest)
- [🐱 Cat’s Den](/docs/THEMES.md#-cats-den)
- [🐶 Dog Pen](/docs/THEMES.md#-dog-pen)
- [🐴 Stables](/docs/THEMES.md#-stables)
- [📌 Notes](/docs/THEMES.md#-notes)
- [⚙️ Core Frameworks & Libraries](/docs/THEMES.md#️-core-frameworks--libraries)
- [🖌️ How these technologies benefit the Theme Loader](/docs/THEMES.md#-how-these-technologies-benefit-the-theme-loader)
- [👥 Author & Links](/docs/THEMES.md#-author--links)

---

## UTILS.md
- [🛠 ParlaChore Utilities](/docs/UTILS.md#-parlachore-utilities)
- [🔧 Utility Classes](/docs/UTILS.md#-utility-classes)
...
- [📌 Notes](/docs/UTILS.md#-notes)
- [👥 Author & Links](/docs/UTILS.md#-author--links)

---

## YAMLBINDING.md
- [🔗 Configuration Binding Overview](/docs/YAMLBINDING.md#-configuration-binding-overview)
    - [YAML → DTO Mapping](/docs/YAMLBINDING.md#yaml--dto-mapping)
    - [Example](/docs/YAMLBINDING.md#example)
    - [Why this matters](/docs/YAMLBINDING.md#why-this-matters)
- [👥 Author & Links](/docs/YAMLBINDING.md#-author--links)
