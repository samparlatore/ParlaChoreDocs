...
- [⚙️ Dynamic Configuration](/CODESAMPLES.md#️-dynamic-configuration)
    - [🛠️ Application configuration](/CODESAMPLES.md#️-application-configuration)
    - [🌱 Spring & Hibernate Configuration](/CODESAMPLES.md#-spring--hibernate-configuration)
- [🧭 Kotlin Enums](/CODESAMPLES.md#-kotlin-enums)
- [📦 Lombok & Jackson for DTO Management & Serialization](/CODESAMPLES.md#-lombok--jackson-for-dto-management--serialization)

---

- [🔒 CSRF Protection Made Simple](/CSRFHANDLING.md)
  - [✅ Utility wrapper for CSRF‑aware fetch](/CSRFHANDLING.md#-utility-wrapper-for-csrf‑aware-fetch)
  - [✅ Using it in your script](/CSRFHANDLING.md#-using-it-in-your-script)
